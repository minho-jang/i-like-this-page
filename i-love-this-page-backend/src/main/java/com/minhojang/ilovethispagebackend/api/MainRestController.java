package com.minhojang.ilovethispagebackend.api;

import com.minhojang.ilovethispagebackend.models.Like;
import com.minhojang.ilovethispagebackend.services.LikeService;
import com.minhojang.ilovethispagebackend.utils.IpAddressUtils;
...
public class MainRestController {
  ...
  public ApiResult likeSave() {
    Like like = new Like(
            null, // id (PK)
            IpAddressUtils.ipv4ToLong("127.0.0.1"),
            null, // ip_address_v6
            "http://localhost:8080/",
            null  // create_at
    );
